...
model_1 <- stan_glm(petitioner_vote ~ pitch_diff + unpleasantDiff_totalWords + 
                    justiceName, 
                    data = all_cases,
...
model_2 <- stan_glm(petitioner_vote ~ unpleasantDiff_totalWords * justiceName, 
                    data = all_cases,
                    family = binomial(link = "logit"), 
...
Overlap <- Pitch_Diff_Plot + UnpleasantWords + QuestionsPlot

# This code places my graphs side by side, still unsure if I want to go this 
# route
